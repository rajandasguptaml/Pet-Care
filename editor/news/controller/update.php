	  ...
	  <head>
        ...
        <legend align="center"><h3>UPDATE</h3></legend>
		    ...
		    <form action="" method="post">
			   <table align="center">
			   <tr>
					<td><input type="hidden" name="id" value="<?php echo $newsp["id"] ;?>"></td>
			         
					 </tr>
			           <tr>
					        <td><span><b>News Intro:</b></span></td>
							
							<td><input type="text" name="bname" value="<?php echo $bname["bname"];?>" size="" placeholder="News_Intro"><br>
					   ...
					   <tr>
				           <td><span><b>News Content:</b></span></td>
					       <td><input type="text" name="content" value="<?php echo $content["content"];?>" placeholder="News Content"><br>
