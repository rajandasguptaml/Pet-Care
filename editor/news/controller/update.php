			   ...
			   <tr>
					<td><input type="hidden" name="id" value="<?php echo $newsp["id"] ;?>"></td>
			           ...
			           <tr>
							...
							<td><input type="text" name="bname" value="<?php echo $newsp["bname"];?>" size="" placeholder="News_Intro"><br>
					   ...
					   <tr>
					       ...
					       <td><input type="text" name="content" value="<?php echo $newsp["content"];?>" placeholder="News Content"><br>
